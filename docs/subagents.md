...
| **MIO** | Auth Guardian (Privy) | `panther-auth` | 6h | auth flows, Privy, wallets | (shared) |

## Quick facts
- **Provider:** `opencode-free` / `muse-spark-1.2-contributor-free` (free, unlimited)
- **Gateway:** `@sageglowsbot` (Telegram) id `8646275630`, paired ☯️
- **TTS:** ElevenLabs Jessica `cgSgspJ2msm6clMCkdW9`
- **Vision:** local `moondream` / `llava:7b` via Ollama
- **Imaging:** ComfyUI `animagine-xl-3.1` (C:/ComfyUI)
- **Cron IDs:** `1d4a12cf83bd` (Kuro), `f046435c05a7` (Hikari), `00a627273861` (Rias), `79d57a7e9bb9` (Mio)
