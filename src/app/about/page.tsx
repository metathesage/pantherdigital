...
export const metadata: Metadata = {
  title: "Wiki — PNTHR DGTL",
  description:
    "The PNTHR DGTL wiki: why we dominate the crypto discovery space, our design system, data sources, security model, and roadmap.",
};
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6">
      ...
      <p className="mt-10 rounded-2xl bg-[#F8F8F7] p-5 text-xs leading-relaxed text-[#9A9A9A] ring-1 ring-black/5">
        PNTHR DGTL is an informational tool. Nothing here is financial advice. Market data is provided by third
