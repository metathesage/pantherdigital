...
// PNTHR DGTL — tiny cached CoinLore asset index (nameid -> numeric id) for keyless price fallback
...
// PNTHR DGTL — server-side proxy for /simple/price. Keeps the key private
// and avoids client CORS/429. Falls back to keyless CoinLore on 429/error.
