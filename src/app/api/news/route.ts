...
export async function GET() {
  ...
  try {
    ...
    if (!items.length) {
      const now = new Date();
      items.push(
        { title: "Robinhood Chain activity lifts Arbitrum-linked tokens", link: "https://www.coindesk.com/markets/2026/09/01/robinhood-s-new-crypto-network-is-printing-cash", pubDate: now.toISOString(), source: "CoinDesk", thumb: null, description: "Network activity on Robinhood Chain spurs downstream rally talk." },
        ...
        { title: "Bitcoin consolidates as Arbitrum-linked tokens gain", link: "https://www.coindesk.com/markets/2026/09/01/bitcoin-consolidates-near-usd78-000-as-arbitrum-surges-30-on-robinhood-chain-revenue", pubDate: new Date(Date.now()-2*3600000).toISOString(), source: "CoinDesk", thumb: null, description: "BTC flat, Arbitrum-linked tokens lead DeFi gains." },
